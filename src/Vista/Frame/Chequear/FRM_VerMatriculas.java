...
public class FRM_VerMatriculas extends javax.swing.JFrame {
     ...
     */
    public FRM_VerMatriculas(ConexionBD baseDatos) 
    {
    ...
    {        
        int numeroFilas = baseDatos.numeroFilasMatricula();
        
        System.out.println("Número de Filas: "+numeroFilas);
        
        String[][] infoTotalMatriculas = baseDatos.InfoTotalMatriculas(numeroFilas);        
        String[][] infoCursosEstudiantes = baseDatos.InfoCursosMatriculas(numeroFilas, infoTotalMatriculas);
        String[] infoEstudiantes = baseDatos.InfoEstudiantesMatriculas(numeroFilas, infoTotalMatriculas);
        ...
        for(int i=0;i<numeroFilas;i++)
        {
            ...
            infoFila[3] = infoCursosEstudiantes[i][0];
            infoFila[4] = infoCursosEstudiantes[i][1];    
